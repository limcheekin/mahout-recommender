...
* @since 0.5
*/
class ItemBasedTanimotoCoefficientRecommenderBuilder implements RecommenderBuilder {
	...
	public Recommender buildRecommender(DataModel model) throws TasteException {
		...
		if (hasPreference) {
		  ...
		  recommender = new GenericBooleanPrefItemBasedRecommender(model, similarity)
		}
		return recommender
	}
}
